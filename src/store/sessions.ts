  ...
  sessions: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'TL;DR',
        '- 思考を停止して Atomic Design を導入した結果の発表 <br> 　- ロジックの集中、コンポーネントの量産 <br> - 導入するときは現場との差分（Vue.js、チーム、プロダクトの性質 etc..）を考えて追加する <br> - 視座をプロダクトのレベルまで高めて、設計判断をする <br> - 改めて Vue.js と Atomic Design ベースでコンポーネント開発を実践した時に考えたこと <br> 　- ドメインを持たせたコンポーネントの組み合わせ <br> 　- ロジックをリポジトリパターンで組み直す'
      ],
      ogImage: 'default.png'
    },
    // {
