<template>
  <BaseMain class="privacy-page">
    ...
    <BaseMainDescription>
      ...
      <p>
        当カンファレンスは、個人情報の紛失、破壊、改ざん及び漏洩などのリスクに対して、個人情報の安全管理が図られるよう、Vue Fes Japan 実行委員およびその関係者に対し、必要かつ適切な監督を行います。
      </p>
    </BaseMainDescription>
