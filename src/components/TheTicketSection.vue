<template>
  <BaseSection class="the-ticket-section">
    ...
    <div class="description">
      <p>
        2019/7/17（水）12:00 から Vue Fes Japan 2019
        のチケットを発売開始します。チケットはアフターパーティーあり/なしの 2
        種類で、全席ランチ付きです。
      </p>
      ...
      <p>
        ...
        を利用します。発売開始のタイミングで本 Web
        サイトにてチケット購入へのリンクが公開されます。購入時に届くメールに QR
        コードが記載されていますので、そちらをチケットとして当日ご持参ください。
      </p>
    </div>
    ...
    <div class="faq">
      ...
      <div class="faq-content">
        ...
        <p>
          各種クレジットカード（Visa、American Express、Discover、MasterCard）と
          Google Pay、Apple Pay がご利用いただけます。
        </p>
      </div>
      ...
      <div class="faq-content">
        ...
        <p>
          ...
          <br />
          また、譲渡に関するトラブルについて Vue.js
          日本ユーザーグループは一切責任を負わないものとします。あらかじめご了承ください。
        </p>
      </div>
      ...
      <div class="faq-content">
        ...
        <p>
          チケットの発売開始までに本 Web
          サイトにて公開予定です。一部内容についてはチケット発売後に公開になる可能性がありますので、あらかじめご了承ください。
        </p>
      </div>
      ...
      <div class="faq-content">
        ...
        <p>
          はい、会場内でお弁当とお飲み物をご提供します。各会場ではランチを召し上がりながら
          Lunch スポンサーセッション（10分 x 3本）にご参加いただけます。
        </p>
      </div>
      ...
      <div class="faq-content">
        ...
        <p>
          当日は受付の混雑が予想されます。受付用の QR
          コードを読み取れるようご準備の上、列へお並びください。QR
          コードはチケット購入時に届くメールをご確認ください。
        </p>
      </div>
      ...
      <div class="faq-content">
        ...
        <p>
          購入時に Universe
          のアカウントを作成するか選択できますが、作成しなくともチケットの購入は可能です。また、チケット購入後でも購入時に届くメールからアカウントを作成することができます。
        </p>
      </div>
    </div>
  </BaseSection>
