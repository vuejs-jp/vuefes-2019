<template>
  <BaseSection class="the-head-section">
    ...
    <div class="notification">
      ...
      <!-- prettier-ignore -->
      <p>
        そこで万が一の開催中止に備えて、Vue Fes Japan 2019 では先日の発表のとおり興行中止保険に加入しています。具体的には、開催当日に開催地より半径 100km 以内に開催に影響を与える自然現象（今回の場合は台風にあたります）がある場合、または開催地への交通機関が運休などで機能しなくなった場合、この 2つの条件のいずれかを満たした場合に一部費用を補償する契約内容です。
      </p>
      ...
      <!-- prettier-ignore -->
      <p>
        2019年10月11日 10:30 Vue.js 日本ユーザーグループ 代表 川口 和也
      </p>
    </div>
